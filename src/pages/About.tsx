            ...
            <div className="max-w-5xl">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="bg-secondary rounded-xl overflow-hidden group hover:shadow-premium-lg transition-all duration-300">
                  ...
                  <div className="p-6">
                    <p className="text-accent-dark text-sm font-medium mb-2">Managing Director</p>
                    <p className="text-muted-foreground text-sm leading-relaxed">
                ...
                <div className="bg-secondary rounded-xl overflow-hidden group hover:shadow-premium-lg transition-all duration-300">
                  <div className="h-48 bg-gradient-to-br from-accent/20 to-primary/20 flex items-center justify-center">
                    <div className="w-24 h-24 rounded-full bg-accent/30 flex items-center justify-center">
                      <span className="text-3xl font-bold text-accent-dark">DHS</span>
                    </div>
                  </div>
                  <div className="p-6">
                    <p className="text-accent-dark text-sm font-medium mb-2">Director of Health Sciences</p>
                    <p className="text-muted-foreground text-sm leading-relaxed">
